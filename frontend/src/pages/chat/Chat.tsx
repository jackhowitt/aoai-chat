...
const Chat = () => {
  ...
  const onShowCitation = (citation: Citation) => {
    // Call onViewSource to navigate to the source URL
    onViewSource(citation);
  };

  const onViewSource = (citation: Citation) => {
    if (citation.url) {
      // Remove '.html' from the end of the URL
      const cleanUrl = citation.url.replace(/\.html$/, "");
        ...
        <div className={styles.chatContainer}>
          {!messages || messages.length < 1 ? (
            <Stack className={styles.chatEmptyState}>
              <h2 className={styles.chatEmptyStateSubtitleBold}>
                Welcome to Market Maven AI, your AI-driven market analyst
                specialising in the regulatory environment.
              </h2>
              <h2 className={styles.chatEmptyStateSubtitle}>
                With an in-depth understanding of the latest regulatory
                developments, it provides insights and perspectives to help you
                navigate the complex and dynamic market landscape.
              </h2>
              <h2 className={styles.chatEmptyStateSubtitle}>
                For data-driven quantitative insights, we recommend you instead
                leverage our Q&A tools located in the sidebar.
              </h2>
              <h2 className={styles.chatEmptyStateSubtitle}>
                Together, they provide a robust understanding of the market
